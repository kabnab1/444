          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                ...
                <span className="px-4 py-2 text-sm font-semibold min-w-[3rem] text-center border-x border-gray-200">
                  {quantity}
                </span>
                <button
            ...
            <div className="flex gap-3 mb-8">
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 font-bold py-3.5 rounded-xl transition-all text-sm ${
                  added
                    ...
                    : 'bg-primary-600 hover:bg-primary-700 text-white shadow-md hover:shadow-lg active:scale-98'
                }`}
              >
                {added ? (
                  <>
              ...
              <Link
                href="/checkout"
                onClick={() => {
                  if (!added) addItem(product, quantity);
                }}
            ...
            {activeTab === 'specs' && product.specs && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {Object.entries(product.specs).map(([key, value]) => (
                  <div
                    key={key}
                    className="flex justify-between py-2.5 px-4 bg-gray-50 rounded-lg text-sm"
                  >
              ...
              <div className="space-y-4">
                ...
                {[
                  ...
                  },
                  {
                    ...
                    rating: 4,
                    date: '1 month ago',
                    comment: 'Great quality, fast shipping. Would recommend to friends.',
                  },
                  {
                    name: 'Mike T.',
                    rating: 5,
                    date: '1 month ago',
                    comment: 'Best purchase I have made this year. Worth every penny!',
                  },
                ].map((review) => (
